...
Command: npx gltfjsx@6.2.13 real-time_bones_demo_phoenix_bird.glb 
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/real-time_bones_demo_phoenix_bird.glb')
  return (
...
useGLTF.preload('/real-time_bones_demo_phoenix_bird.glb')
